...
export const fetchFastMovingChart = createAsyncThunk('app/fetchTopTenProduct', async () => {
  try {
...
export const getProductMetrics = createAsyncThunk('app/dashboard/product', async ({id, LocationID}:any) => {
  try {
    var url = `https://cafemgrlapi.beyondexs.com/api/get/saleshistory/salesfilter/${id}/${LocationID ? LocationID : 0}`;
    var token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..LjLzqk_fnDYPK68u9s66iyLZzwIHOTU5VCLU0cKAbtoAZDkig6N3CFE4GdQzy3wsM5zEfQmL7l7WlUIkqc_Je4j10Yg173p_uilOUjXibPhT18-MEn5UX6m-SwTsMy8GVL5OKDuPHgz88LY836MD3NAr8UKjkOdSBZ8XeN_fWMMDjRnMkqE7na9phBEEbKDsH7DcSLeb97IBCnetwtOUlqGpdxz0TZPVG0d4vz7I5EfWnPHJhDJjPCOYBo-WHwr-NvNOQPgcKmuLn5rKVFLOAse7s0ACqCH6RNVusXv_uy37Nh3Q_hk4cTIWeGSc2Fbk0OikzCC5WRTSbzGyEql7G7nVLRuVzPXdoiWwE3tppHtavdcQOW9bY0by6AgoPl3lohIWe1R9lAp-5LEOezxIxIA78Y2bI-dq_uqAHdxtfVKI6UDNqbRow8ssGe_mzzmm_NDHXcUgZb9rz_idfZgACIXmoViZgZSY3gTtQOx7xicE81v4zek0S6oW4Z-OBNNWxrWmhGkedbv4J0gyqWCIc-hX2_1uCmAyW8_87MhFu5gMd95bls-09pZsJVYbnuzLfALnOgbrTuB-IRaFxswQX4elAImtxI-obQ7iGD8u2lw3WOmrWQFI-WlBLBQ-WF2BQ5Q7q5rGN9kRSArwCj33ItV7gWPOuOXDQAtiAaSOGNk';
...
export const globalSlice = createSlice({
  ...
  reducers: {
   ...
   blockChange: (state, action: PayloadAction<string>) => {
...
export const { setIsDarkMode, setIsSidebarcollapsed,blockChange } = globalSlice.actions;
